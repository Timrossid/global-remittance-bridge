...
| **Google Form (Feedback)** | ⏳ _Pending owner creation_ — see the [form spec](docs/FEEDBACK_FORM_SPEC.md) with the exact 10 questions, prefill URL builder, and Excel export steps. |
