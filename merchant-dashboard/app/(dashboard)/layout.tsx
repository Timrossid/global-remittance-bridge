...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (stored) {
        ...
        setMerchantName(m.name || m.email || 'Merchant');
      }
    } catch {
      // ignore parse errors
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-72 max-w-[85vw] bg-white border-r transform transition-transform lg:translate-x-0 lg:static lg:inset-auto lg:w-64 ${
      ...
      >
        <div className="flex items-center gap-3 px-6 py-5 border-b">
          ...
          <div>
            <p className="font-semibold text-sm text-gray-900 leading-tight">Remittance Bridge</p>
